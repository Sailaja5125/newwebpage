...
export const Timeline = ({ data }) => {
  ...
  // Calculate the height of the timeline content after mount
  useEffect(() => {
  ...
  return (
    <div
      className="w-full  dark:bg-neutral-900 font-sans md:px-10 bg-white"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl font-zentry">
          Event Itinerary
        </h2>
